...
import { Search, ArrowRight, Globe, Bot, Shield, X, Plus, Sun, Moon } from 'lucide-react'
    ...
    <div className="min-h-screen grid-bg relative overflow-hidden">
      ...
      <nav className="relative z-10 max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-sm">
          <a href="#features" className="hidden sm:block text-muted hover:text-heading transition-colors">Features</a>
          <a href="#how" className="hidden sm:block text-muted hover:text-heading transition-colors">How it works</a>
          <span
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 pt-12 pb-6 text-center">
        ...
        >
          {/* Mode tabs */}
          <div className="flex flex-wrap gap-1 p-1 rounded-xl mb-6 w-full sm:w-fit" style={{ background: 'rgba(0,0,0,0.3)' }}>
            {([
            ...
            {mode === 'compare' && (
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                ...
                <div className="flex sm:flex-col items-center gap-2 px-1 shrink-0">
                  <div className="flex-1 sm:flex-none sm:h-8 w-px sm:w-px h-px sm:h-auto bg-border" />
                  <span className="text-muted text-xs font-mono font-bold px-2 py-1 rounded" style={{ background: 'rgba(255,255,255,0.05)' }}>VS</span>
                  <div className="flex-1 sm:flex-none sm:h-8 w-px sm:w-px h-px sm:h-auto bg-border" />
                </div>
                <div className="relative flex-1">
